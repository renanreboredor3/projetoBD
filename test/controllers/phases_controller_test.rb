...
class PhasesControllerTest < ActionController::TestCase
  ...
  test "should create phase" do
    assert_difference('Phase.count') do
      post :create, phase: { event_id: @phase.event_id, name: @phase.name, phase_date: @phase.phase_date }
    end
  ...
  test "should update phase" do
    patch :update, id: @phase, phase: { event_id: @phase.event_id, name: @phase.name, phase_date: @phase.phase_date }
    assert_redirected_to phase_path(assigns(:phase))
  end
